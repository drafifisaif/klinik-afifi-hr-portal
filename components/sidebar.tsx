...
export function Sidebar({ currentPath, navigation, profile }: SidebarProps) {
  return (
    <>
      <aside className="hidden w-[280px] shrink-0 border-r border-white/70 bg-white/80 px-5 py-6 shadow-[0_24px_48px_rgba(18,42,44,0.05)] backdrop-blur lg:flex lg:flex-col">
